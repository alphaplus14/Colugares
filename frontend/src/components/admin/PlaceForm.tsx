...
export function PlaceForm({ initialData, mode }: PlaceFormProps) {
  ...
  const inputClass =
    "w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-colombia-green focus:outline-none focus:ring-1 focus:ring-colombia-green";
    ...
    <form onSubmit={handleSubmit} className="max-w-3xl space-y-6">
      ...
      <div className="flex gap-3">
        ...
        <button
          type="button"
          onClick={() => router.back()}
          className="rounded-md border border-gray-300 px-6 py-2.5 text-sm font-medium hover:bg-gray-50"
        >
          Cancelar
        </button>
      </div>
